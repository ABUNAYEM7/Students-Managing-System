        ...
        return (
          <div key={item._id} className="card bg-base-100 shadow-xl mb-6">
            <div className="card-body">
              ...
              <p><strong>Course ID:</strong> {item.courseCode}</p>
              ...
              {!hasSubmitted && (
                <p>
                  ...
                  <Countdown date={new Date(item.deadline)} renderer={renderer} />
                </p>
              )}
              ...
              {!hasSubmitted ? (
                ...
                <div className="flex items-center justify-center">
                  <a
                    ...
                    href={`http://localhost:3000/${item.submission.path.replace(/\\/g, '/')}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    View Submission
